...
public:	
	...
	// Legacy no-op retained for Blueprint/native asset compatibility.
	void	UpdateMachineArmLevel()
	{
...
public:	
	...
	void ApplyMachineArmStat(const FMachineArmStat& NewStat)
	{
		// MachineArm feature retired.
		// MachineArmStat__ = NewStat;
		// UpdateMachineArmLevel();
	}
