...
class UOpenableWidgetInterface : public UInterface
{
	GENERATED_BODY()
};
 ...
 * 
 */
class PROJECTSR_API IOpenableWidgetInterface
{
	GENERATED_BODY()

	// Add interface functions to this class. This is the class that will be inherited to implement this interface.
public:
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "OpenableWidget")
	void	OpenSelfWidget();

	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "OpenableWidget")
	void	CloseSelfWidget();
